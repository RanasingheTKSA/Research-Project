...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ConfigureServices
    {
        public static IServiceCollection AddEduArkInfrastructureTenantServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<ITenantDbContext>(provider => provider.GetRequiredService<TenantDbContext>());
            ...
            services.AddTransient<IRatingTypeQueryRepository, RatingQueryRepository>();
            services.AddTransient<IRatingCommandRepository, RatingCommandRepository>();
