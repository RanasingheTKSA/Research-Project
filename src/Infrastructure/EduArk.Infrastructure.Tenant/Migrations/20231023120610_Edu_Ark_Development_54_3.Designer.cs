...
namespace EduArk.Infrastructure.Tenant.Migrations
{
    ...
    [Migration("20231023120610_Edu_Ark_Development_54_3")]
    partial class Edu_Ark_Development_54_3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduArk.Domain.Entities.Tenant.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduArk.Domain.Entities.Tenant.Rating", b =>
                {
                    b.HasOne("EduArk.Domain.Entities.Tenant.User", "CreatedByUser")
                        .WithMany("CreatedUserRating")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EduArk.Domain.Entities.Tenant.User", "UpdatedByUser")
                        .WithMany("UpdatedUserRating")
                        .HasForeignKey("UpdatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("EduArk.Domain.Entities.Tenant.User", b =>
                {
                    ...
                    b.Navigation("CreatedUserRating");
                    ...
                    b.Navigation("UpdatedUserRating");
