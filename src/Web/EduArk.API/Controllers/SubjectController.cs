...
namespace EduArk.API.Controllers
{
    ...
    public class SubjectController : ControllerBase
    {
        ...
        //getAcademicLevelWithSubjectList
   /*     [HttpGet("getAcademicLevelWithSubjectList")]
        public async Task<IActionResult> GetAcademicLevelWithSubjectList()
        {
            var response = await _mediator.Send(new GetAcademicLevelWithSubjectListQuery());
            return Ok(response);
        }*/
