...
public class User : BaseAuditableEntity
{
    public User()
    {
        ...
        CreatedUserRating = new HashSet<Rating>();
        UpdatedUserRating = new HashSet<Rating>();
    }
    ...
    public virtual ICollection<Rating> CreatedUserRating { get; set; }
    public virtual ICollection<Rating> UpdatedUserRating { get; set; }
